...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LGUI,  KC_LALT,  _______, _______, LOWER,  KC_BSPC,   KC_LCTL,   LALT(KC_LSFT), KC_ENT,   KC_SPC,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
    ...
    _______,  RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, _______, LALT(KC_LSFT), _______, KC_PGUP, LCTL(KC_INS), KC_PGDN, _______, _______, _______,\
    RGBRST, RGB_SMOD,RGB_HUD, RGB_SAD, RGB_VAD, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
      ),
